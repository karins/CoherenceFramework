...
public class BipartiteGraphTest extends TestCase {
	...
	public void testFrenchGraphCorrectStructure(){
		...
		assertEquals(message, 3, bipartiteGraph.getLocalCoherence(teststring1, BipartiteGraph.UNWEIGHTED_PROJECTION));
	...
	public void testCoherenceValue(){
		...
		assertEquals(message, Math.round(1.0/3.0 * 2.0) , Math.round(bipartiteGraph.getLocalCoherence(teststring1, BipartiteGraph.UNWEIGHTED_PROJECTION)));
	...
	public void testCoherenceValueRanking(){
		...
		assertTrue(message2,  Math.round(bipartiteGraph2.getLocalCoherence(teststring1, 
				BipartiteGraph.UNWEIGHTED_PROJECTION)) >  Math.round(bipartiteGraph.getLocalCoherence(incoherentString1, BipartiteGraph.UNWEIGHTED_PROJECTION)));
